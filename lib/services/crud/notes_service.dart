...
import 'package:kwikwinotes/services/crud/crud_exceptions.dart';
...
class DatabaseNote {
  ...
  DatabaseNote.fromRow(Map<String, Object?> map)
      : id = map[idCol] as int,
        ...
        isSyncedWithCloud =
            (map[isSyncWithCloudCol] as int) == 1 ? true : false;
  @override
  String toString() =>
...
const textCol = 'text';
const isSyncWithCloudCol = 'is_sync_with_cloud';
